...
public class Restaurant { //create class called Restaurant
    ...
    for (int orderNumber = 1; orderNumber <= 20; orderNumber++) {
        System.out.println("Hello! Can I please take your Order? Order #" + orderNumber); //Asks for oder and prints order number
        ...
        System.out.println("Order: " + menuItems[itemNumber]); //prints order item
}
